    ...
    <>
      <div className="prose mb-8">
        ...
        <div className="space-y-6">
          <div className="p-6 rounded-xl bg-green-50 border border-green-400">
            <h2 className="pt-0 mt-0">
              Interested to know more about acid soil management in sub-Saharan
              Africa?
            </h2>
            <p>
              Our <Link href="/data">dashboard</Link> provides state-of-the-art
              data and information on acid soil management for the major cereal,
              legume, root and tuber, and commodity crops in sub-Saharan Africa.
              The following can be found and downloadable open access from our
              dashboard either as a spatial product or tabular summaries
              disaggregated for different administrative units:
            </p>
            <ol>
              <li>
                Distribution and characterization acid soils (soil pH,
                exchangeable acidity, ECEC).
              </li>
              <li>
                Lime rates required to increase crop production and expected
              ...
              <li>
                State-of-the-art technical and scientific resources on soil
                acidity and acid soil management.
              </li>
            </ol>
            <p>
          ...
          <div className="p-6 rounded-xl bg-lime-50 border border-lime-400">
            <h2 className="pt-0 mt-0">
              Our &apos;agronomy-to-scale&apos; approach
            </h2>
            <p>
              Soil acidity can negatively impact crop production and fertilizer
              use efficiency through a series of soil chemical and biological
              conditions associated with low pH, most notably aluminum toxicity.
              Our ‘agronomy-to-scale’ approach to understand and tackle this
              problem encompasses an ex-ante assessment to prioritize crop by
              geography combinations benefiting most from acid soil management
              followed by local validation through agronomy and socio-economic
              research with regional partners and authorities. See an example of
          ...
          <div className="p-6 rounded-xl bg-yellow-50 border border-yellow-400">
            <h2 className="mt-0">Our team and expertise</h2>
            <p>
              Our team is composed of agronomists, soil scientists, and
